...
Knowing is an act to update the credence of a claim. This is the subject of [Verifiable Knowledge](/verifiable-knowledge); the property that matters here, a verdict a model cannot author for itself, is the one §(right-regime) turns into a capability lift. In the Hypothesis Graph, knowledge has the following properties:
