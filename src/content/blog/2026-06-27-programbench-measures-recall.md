...
*Right of reply offered to the ProgramBench authors; data and re-runnable audit at [github.com/kimjune01/program-bench-audit](https://github.com/kimjune01/program-bench-audit); archived at [10.5281/zenodo.21083756](https://doi.org/10.5281/zenodo.21083756). Corrections will be incorporated and the offer stands.*
...
<svg viewBox="0 0 660 330" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:660px;margin:1.6em auto;display:block" role="img" aria-label="A specified oracle accepts the whole region of contract-correct outputs; a pseudo-oracle accepts only the reference's golden point, so a candidate correct by the contract but with different bytes fails.">
  <style>
  ...
  <text x="168" y="28" text-anchor="middle" class="ttl">specified oracle</text>
  <text x="168" y="46" text-anchor="middle" class="sub">judges against the contract</text>
  <ellipse cx="168" cy="192" rx="140" ry="84" fill="#2d7d2d" fill-opacity="0.09" stroke="#2d7d2d" stroke-width="1.5"/>
  <text x="168" y="142" text-anchor="middle" class="lbl">contract-correct outputs</text>
  <circle cx="214" cy="176" r="5" fill="#333"/>
  <text x="214" y="196" text-anchor="middle" class="sub">candidate</text>
  <text x="226" y="172" class="mk" fill="#2d7d2d">&#10003;</text>
  <circle cx="126" cy="224" r="5" fill="#333"/>
  <text x="126" y="246" text-anchor="middle" class="sub">golden</text>
  <text x="138" y="220" class="mk" fill="#2d7d2d">&#10003;</text>
  <text x="492" y="28" text-anchor="middle" class="ttl">pseudo-oracle</text>
  <text x="492" y="46" text-anchor="middle" class="sub">judges against one reference run</text>
  <ellipse cx="492" cy="192" rx="140" ry="84" fill="none" stroke="#999" stroke-width="1.3" stroke-dasharray="5 4"/>
  <text x="492" y="142" text-anchor="middle" class="lbl">contract-correct outputs</text>
  <circle cx="538" cy="176" r="5" fill="#333"/>
  <text x="538" y="196" text-anchor="middle" class="sub">candidate</text>
  <text x="550" y="172" class="mk" fill="#c0392b">&#10007;</text>
  <circle cx="446" cy="222" r="25" fill="#2d7d2d" fill-opacity="0.12" stroke="#2d7d2d" stroke-width="1.3"/>
  <circle cx="446" cy="222" r="5" fill="#333"/>
  <text x="446" y="262" text-anchor="middle" class="sub">golden</text>
  <text x="458" y="218" class="mk" fill="#2d7d2d">&#10003;</text>
  <text x="330" y="308" text-anchor="middle" class="cap">The contract is a region; the captured golden is a single point.</text>
  <text x="330" y="322" text-anchor="middle" class="cap">A candidate correct by the contract but off the golden's bytes fails the pseudo-oracle.</text>
</svg>
...
<svg viewBox="0 0 660 312" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:660px;margin:1.6em auto;display:block" role="img" aria-label="Many functions pass through the same finitely many probed inputs and diverge at the hidden test input; no finite sample identifies the function.">
  <style>
    .lbl{font-family:ui-monospace,Menlo,monospace;fill:#666;font-size:12px}
    .sub{font-family:ui-monospace,Menlo,monospace;fill:#666;font-size:11px}
    .cap{font-family:ui-monospace,Menlo,monospace;fill:#666;font-size:11px}
  </style>
  <line x1="60" y1="250" x2="620" y2="250" stroke="#bbb" stroke-width="1"/>
  <text x="615" y="268" text-anchor="end" class="sub">input</text>
  <path d="M120,175 C165,120 215,118 255,120 C300,122 325,150 360,150 C420,150 485,108 545,82" fill="none" stroke="#555" stroke-width="1.6"/>
  <path d="M120,175 C170,150 220,118 255,120 C305,122 320,150 360,150 C420,150 480,158 545,162" fill="none" stroke="#555" stroke-width="1.6" stroke-dasharray="6 4"/>
  <path d="M120,175 C175,178 225,128 255,120 C310,114 335,170 360,150 C420,150 490,205 545,228" fill="none" stroke="#555" stroke-width="1.6" stroke-dasharray="2 4"/>
  <circle cx="120" cy="175" r="4.5" fill="#333"/>
  <circle cx="255" cy="120" r="4.5" fill="#333"/>
  <circle cx="360" cy="150" r="4.5" fill="#333"/>
  <text x="240" y="100" text-anchor="middle" class="lbl">probed inputs: every function agrees</text>
  <line x1="545" y1="60" x2="545" y2="250" stroke="#999" stroke-width="1.1" stroke-dasharray="4 4"/>
  <circle cx="545" cy="82" r="4" fill="none" stroke="#555"/>
  <circle cx="545" cy="162" r="4" fill="none" stroke="#555"/>
  <circle cx="545" cy="228" r="4" fill="none" stroke="#555"/>
  <text x="545" y="268" text-anchor="middle" class="sub">hidden test input</text>
  <text x="330" y="292" text-anchor="middle" class="cap">Many functions fit every probed input and part at the one the hidden test grades.</text>
  <text x="330" y="306" text-anchor="middle" class="cap">No finite sample picks out the function.</text>
</svg>
...
## Completeness vs. coverage {#coverage}
...
<svg viewBox="0 0 660 200" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:660px;margin:1.6em auto;display:block" role="img" aria-label="The golden is captured from the reference run, then used to grade the candidate; it is the reference's own output, fixed before any check that it is the task's contract.">
  <style>
    .bx{fill:none;stroke:#999;stroke-width:1.3}
    .bxg{fill:#2d7d2d;fill-opacity:0.09;stroke:#2d7d2d;stroke-width:1.4}
    .t1{font-family:ui-monospace,Menlo,monospace;fill:#333;font-size:12px}
    .t2{font-family:ui-monospace,Menlo,monospace;fill:#666;font-size:11px}
    .cap{font-family:ui-monospace,Menlo,monospace;fill:#666;font-size:11px}
    .ax{font-family:ui-monospace,Menlo,monospace;fill:#999;font-size:10px}
  </style>
  <line x1="40" y1="32" x2="620" y2="32" stroke="#ccc" stroke-width="1"/>
  <path d="M620,32 l-8,-3 v6 z" fill="#ccc"/>
  <text x="40" y="24" class="ax">time</text>
  <rect x="40" y="60" width="176" height="58" rx="8" class="bx"/>
  <text x="128" y="86" text-anchor="middle" class="t1">run the reference</text>
  <text x="128" y="104" text-anchor="middle" class="t2">observe its output O</text>
  <line x1="216" y1="89" x2="248" y2="89" stroke="#999" stroke-width="1.3"/>
  <path d="M248,89 l-8,-3 v6 z" fill="#999"/>
  <rect x="248" y="60" width="176" height="58" rx="8" class="bxg"/>
  <text x="336" y="86" text-anchor="middle" class="t1">golden := O</text>
  <text x="336" y="104" text-anchor="middle" class="t2">saved as the standard</text>
  <line x1="424" y1="89" x2="456" y2="89" stroke="#999" stroke-width="1.3"/>
  <path d="M456,89 l-8,-3 v6 z" fill="#999"/>
  <rect x="456" y="60" width="176" height="58" rx="8" class="bx"/>
  <text x="544" y="86" text-anchor="middle" class="t1">grade candidate P</text>
  <text x="544" y="104" text-anchor="middle" class="t2">P == golden ?</text>
  <text x="330" y="156" text-anchor="middle" class="cap">The standard is set at the middle step, the reference's own output,</text>
  <text x="330" y="172" text-anchor="middle" class="cap">before anything checks that it is the task's contract.</text>
</svg>
