...
When taxes are optional, it pays to be a libertarian. The incentive structure rewards it. Every dollar routed through email is enforcement capacity the government can't fund, and weaker enforcement drives more email routing. The loop compounds. In a generation or two, the grip loosens — not through revolution, but through attrition.
