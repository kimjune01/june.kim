...
The [relational pattern](https://en.wikipedia.org/wiki/Procession_(theology)) maps to the [monoid](/cons):
...
<img src="/assets/trinity-parallel.svg" alt="Two triangles side by side. Left: epmem/smem/pmem with arrows consolidate/shapes/generates. Right: Spirit/Father/Son with arrows intercedes/begets/sends. Same geometry, different vocabulary." style="width:100%; display:block;">
</div>
