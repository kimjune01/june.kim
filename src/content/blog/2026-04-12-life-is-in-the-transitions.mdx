...
The [perceptual physics](/gui-before-computers) explain why these metaphors work — Gestalt continuity, least surprise, signal-to-noise. This post is about which metaphor to pick.
...
- [Excalidraw](https://github.com/excalidraw/excalidraw) (MIT) — tool modes, modal transitions, and collaboration state changes with consistent visual language.
- [Immich](https://github.com/immich-app/immich) (AGPL-3.0) — photo detail transitions, selection mode shifts, upload progress states.
