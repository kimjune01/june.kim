...
When the buyer's agent is an LLM processing embedding vectors rather than a person scanning banner ads, what does the auction mechanism need to look like? It needs to operate in the space where the AI actually represents intent.
...
- **Open-weight models** (Nomic, BGE, GTE) make the embedding step independently verifiable
