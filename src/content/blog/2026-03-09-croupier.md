...
- **Redemption rate**: what % of issued coupons convert? Low rate means the product or the landing page is the problem. The publisher isn't at fault.
...
All countable from envelopes. None of it requires seeing conversion value. The advertiser's margins stay opaque. The publisher sees that coupons convert; it doesn't see what they're worth.
