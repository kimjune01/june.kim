...
So I said nothing. Most of us eventually learn to prefer silence over the shape of that debt.
...
The writing is [CC-BY-SA](https://creativecommons.org/licenses/by-sa/4.0/). The code is [AGPL-3.0](https://www.gnu.org/licenses/agpl-3.0.html). The pattern can be implemented by anyone. It cannot be walled off by anyone.
...
We are on more channels than have ever existed, and we keep getting lonelier. The Surgeon General declared loneliness a public health epidemic [in 2023](https://www.hhs.gov/sites/default/files/surgeon-general-social-connection-advisory.pdf), reporting that young people aged 15 to 24 spend seventy percent less time in person with friends than they did two decades ago. Gen Alpha is heading the same way: [one in five parents](https://mottpoll.org/reports/facilitating-friendships-parents-role) of children 6 to 12 say their child has too few friends, and nine in ten of those children say they wish they had more.
...
The default is what matters, because the default is what most moments get, and in a persistent channel the default is performance. In this one it is not.
