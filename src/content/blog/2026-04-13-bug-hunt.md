...
The [bug-hunt skill](https://github.com/kimjune01/june.kim/blob/master/skills/bug-hunt/skill.md) is a Claude Code slash command that runs this loop. Point it at a spec and a codebase, and it hunts to convergence. Our [forge skill](https://github.com/kimjune01/june.kim/blob/master/skills/forge/skill.md) calls it as step 3 of a four-step pipeline: sharpen the spec, blind-blind-merge the implementation, hunt to convergence, then clean for PR.
