...
Membership is provisional by construction, a canon of standing builds and not settled truths, so it never collides with the asymptote. This dissolves an old worry: it is a canon of the *activity*, the builds that still pass, not the *institution*, a credentialed corpus held true by authority. Membership is by entitlement, not reputation, merit attaching to the work rather than the name on it.
...
Here is the worst thing you can say about verifiable knowledge, said as nastily as it goes. *This is Brandomian inferentialism plus Davidsonian triangulation plus AGM belief revision plus executable provenance infrastructure. The philosophical claims are inherited, the machine claims are ordinary reproducibility engineering, the three-state ledger is old many-valued bookkeeping, and the result is a useful architecture, not a new epistemology.* Concede every piece. The concession is the strength.
