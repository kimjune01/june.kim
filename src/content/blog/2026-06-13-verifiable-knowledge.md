...
An authority-held corpus has no reverse gear: nothing binds a retraction to propagate, so a correction need not travel as fast as the claim it corrects. The canon propagates it mechanically, because it never let the claim come apart from its build.
