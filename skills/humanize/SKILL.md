...
- *Suspense label*: a dramatizing colon-label bolted in front of real content. "The catch:", "The kicker:", "The twist:", "Here's the thing:", "The thing is:". ("But"/"Except" usually does the same work; bare field labels "Repro:", "Fix:" are fine.)
- *Fragment hook*: a self-posed mini-question answered curtly. "The result? Devastating.", "And honestly?".
- *Question framing*: the word *question* standing in for content. "The question is whether X", "the real question is", predicate-nouned claims ("it's a definite-assignment question" → "that turns on definite assignment"). Repeated "... question" across a passage is the strongest signal.
