...
8. **Codex sniff.** Before presenting to the human, send O.md to codex. Apply obvious improvements directly (weak code citations, missing tower table entries, SVG inconsistencies). Present only ambiguous or debatable points to the human alongside the elicitation questions. **If codex is unavailable**, perform a self-review pass applying the same criteria. Log which reviewer was used or skipped.
