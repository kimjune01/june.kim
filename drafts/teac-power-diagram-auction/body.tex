...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={The allocation is the upper envelope of the reported-value curves (their logs are the score parabolas). Winning intervals along the axis are the power-diagram cells. A bid sets each curve's height, a center its position, \textbackslash sigma its width.}]{vcg-fig1.pdf}}
