...
AI systems / research engineer building cognition, epistemology, and agentic workflows as foundations for better AI-assisted software. 10+ years of software engineering experience at Google, Loom, and startups. Builds working systems, runs artifact-level experiments, and turns research ideas into public tools, protocols, and evidence.
...
- Developed a theory-to-artifact research program on abduction, memory, provenance, review loops, and LLM quality degradation.
- Created technical research notes including The Natural Framework, The Hypothesis Graph, Modes of Reason, Abduction, The Parts Bin, and Memory Compression.
- Used the framework to guide experiments and systems: Slop Slope, agentic open-source contribution pipelines, PageLeft, and runnable textbooks.
...
- Built end-to-end RAG ingestion pipeline: filtered, extracted, parsed, and condensed unstructured desktop accessibility data into a searchable vector store.
